...
Start Zookeeper: Zookeeper is a prerequisite for running Kafka, as it manages the state and configuration of the Kafka cluster. Start a Zookeeper container using the Confluent Docker image
